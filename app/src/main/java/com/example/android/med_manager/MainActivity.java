...
public class MainActivity extends AppCompatActivity
    ...
    private class MyAdapter extends BaseAdapter {
        ArrayList<PillsLedger.PillDetails> medList;

        private MyAdapter(ArrayList<PillsLedger.PillDetails> ledgerArrayInstance) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final PillsLedger.PillDetails pill = medList.get(position);
